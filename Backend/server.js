...
app.use(cors({
  origin: [
    ...
    "http://44.203.253.121:3422",
    "http://127.0.0.1:5500",
    "http://44.203.253.121:5500",
    "http://127.0.0.1:5501",
    "http://127.0.0.1:5503",
    "http://44.203.253.121:8043",
    "http://44.203.253.121:8044",
  ],
...
// Start server
app.listen(port, () => {
  console.log(`Server running on http://44.203.253.121:${port}`);
});
